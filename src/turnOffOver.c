...
static void draw_row_callback(GContext *ctx, const Layer *cell_layer, MenuIndex *cell_index, void *context) {
  switch(cell_index->row) {
    case 0:
      menu_cell_basic_draw(ctx, cell_layer, "10 s", NULL, NULL);
      break;
    case 1:
      menu_cell_basic_draw(ctx, cell_layer, "30 s", NULL, NULL);
      break;
    case 2:
      menu_cell_basic_draw(ctx, cell_layer, "2 min", NULL, NULL);
      break;
    case 3:
      menu_cell_basic_draw(ctx, cell_layer, "5 min", NULL, NULL);
      break;
    default:
      break;
  }
...
static void select_callback(struct MenuLayer *menu_layer, MenuIndex *cell_index, void *context) {
  switch(cell_index->row) {
    case 0:
      send(DURATION_OFF, 10);
      break;
    case 1:
      send(DURATION_OFF, 30);
      break;
    case 2:
      send(DURATION_OFF, 120);
      break;
    case 3:
      send(DURATION_OFF, 300);
      break;
    default:
      break;
  }
...
void turnOffOver_layer_window_push() {
